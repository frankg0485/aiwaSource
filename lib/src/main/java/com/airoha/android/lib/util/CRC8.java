...
public class CRC8 implements Checksum
{
    ...
    private final short ByteReverse_Table[] =
    {
    ...
    public void update(byte[] buffer, int offset, int len)
    {
        ...
        while (len-- > 0)
        {
            ...
            short tmp = (short)(buffer[offset] & 0xFF);
            value = crcTable[tmp ^ value];
            offset++;
        }
        value = (byte)((ByteReverse_Table[value & 0x0F] << 4) | ByteReverse_Table[value >> 4]);
    }
